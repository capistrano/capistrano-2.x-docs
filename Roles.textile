...
<pre>
role :db, 'db1.example.com', :primary => true, :no_release => false # This one, to run migrations will require the code.
role :db, %w{db2.example.com db3.example.com}, :no_release => false
</pre>
