...
In addition to role() there is also server() which is for defining an individual server, and speficying a role; there are circumstances when this is prefereable.
