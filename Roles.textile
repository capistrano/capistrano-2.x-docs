...
|^. <code>:web</code> | This is assumed to be your web servers (read: nginx / Apache / etc.) |
|^. <code>:app</code> | These are assumed to be your application servers, in a Ruby environment this means something like Unicorn, Passenger, Mongrel or Mongrel Cluster. |
...
role :db, 'db2.example.com', 'db3.example.com', :no_release => true
</pre>
