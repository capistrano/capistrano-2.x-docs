...
Capistrano is actually comprised of the Capistrano gem itself, and SSH drivers written in pure Ruby.

To use Capistrano your RubyGems should be at least 1.3.x, if not please follow their upgrade instructions and come back here... with RubyGems up to date, you can install Capistrano and its dependencies with the following:

    # gem install capistrano

There will be many additional dependencies, you should notice they are SSH drivers, SFTP driver and more.
