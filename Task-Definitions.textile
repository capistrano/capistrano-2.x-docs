...
We're also using the "capture()":http://rdoc.info/rdoc/capistrano/capistrano/blob/master/Capistrano/Configuration/Actions/Inspect.html#capture-instance_method 